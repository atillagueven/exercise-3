...
- **Crop**: Product of the farm with is growing with optimal moisture level
- **Wheat**: A Crop which has a minimum required moisture level of 120
- **Corn**: A Crop which has a minimum required moisture level of 80
- **ActionAffordance**: Affordances enables traktors to interact with the land sections
